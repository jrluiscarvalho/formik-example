...
import handleCreditCardValidation from './handleCreditCard'
...
const schema = Yup.object().shape({
  ...
  creditCard: Yup.string()
    .test('validate credit card', 'Cartão inválido', number => handleCreditCardValidation(number))
})
...
const MyForm = props => {
  return (
    <Form>
      ...
      <div>
        <Field name="creditCard" placeholder="Cartão de Crédito" /> <br />
